...
-- Trazer os funcionários (vendedores) que estão e não estão associados a nenhum cliente
SELECT a.employeeNumber, b.customerNumber
FROM customers b
RIGHT JOIN employees a
ON b.salesRepEmployeeNumber = a.employeeNumber
