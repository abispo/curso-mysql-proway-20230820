...
INSERT INTO tb_customers (customer_id, customer_name, contact_name, address, city, postal_code, country)
VALUES
...
INSERT INTO tb_categories (category_id, category_name, description)
VALUES
...
INSERT INTO tb_employees (employee_id, last_name, first_name, birth_date, photo, notes)
VALUES
...
INSERT INTO tb_suppliers (supplier_id, supplier_name, contact_name, address, city, postal_code, country, phone)
VALUES
...
INSERT INTO tb_shippers (shipper_id, shipper_name, phone)
VALUES
...
CREATE TABLE tb_products (
    ...
    unit VARCHAR(255),
    price DECIMAL(10, 2),
    FOREIGN KEY (supplier_id) REFERENCES tb_suppliers(supplier_id),
    FOREIGN KEY (category_id) REFERENCES tb_categories(category_id)
);

-- Inserção de registros na tabela tb_products
INSERT INTO tb_products (product_id, product_name, supplier_id, category_id, unit, price)
VALUES
...
CREATE TABLE tb_orders (
    ...
    FOREIGN KEY (shipper_id) REFERENCES tb_shippers(shipper_id)
);
...
CREATE TABLE tb_orders_details (
